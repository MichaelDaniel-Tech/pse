        ...
        <div class="panel panel-primary animated zoomIn xn-drop-left xn-panel-dragging">
            ...
            <div class="panel-body list-group list-group-contacts scroll" style="height: 200px;">
                <a href="#" class="list-group-item">
                    ...
                    <img src="{{ url('/assets/images/users/user2.jpg') }}" class="pull-left"
                        alt="John Doe" />
                ...
                <a href="#" class="list-group-item">
                    ...
                    <img src="{{ url('/assets/images/users/user.jpg') }}" class="pull-left"
                        alt="Dmitry Ivaniuk" />
                ...
                <a href="#" class="list-group-item">
                    <div class="list-group-status status-away"></div>
                    <img src="{{ url('/assets/images/users/user3.jpg') }}" class="pull-left"
                        alt="Nadia Ali" />
                ...
                <a href="#" class="list-group-item">
                    ...
                    <img src="{{ url('/assets/images/users/user6.jpg') }}" class="pull-left"
                        alt="Darth Vader" />
